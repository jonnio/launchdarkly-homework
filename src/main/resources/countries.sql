INSERT INTO COUNTRY (country_name, code, population, gdp)
VALUES ('Afghanistan', 'AFG', 32526562, 594.323081219966),
       ('Albania', 'ALB', 2889167, 3945.21758150914),
       ('Algeria', 'ALG', 39666519, 4206.03123244958),
       ('American Samoa', 'ASA', 55538, 0.0),
       ('Andorra', 'AND', 70473, 0.0),
       ...
       ('British Virgin Islands', 'IVB', 30117, 0.0),
       ...
       ('Libya', 'LBA', 6278438, 0.0),
       ('Liechtenstein', 'LIE', 37531, 0.0),
       ...
       ('Netherlands Antilles', 'AHO', 0, 0.0),
       ...
       ('Palestine Occupied Territories', 'PLE', 0, 0.0),
       ('Panama', 'PAN', 3929141, 13268.1137549335),
       ('Papua New Guinea', 'PNG', 7619321, 0.0),
       ...
       ('Trinidad Tobago', 'TRI', 1360088, 17321.884675056),
       ...
       ('Venezuela', 'VEN', 31108083, 0.0),
       ('Vietnam', 'VIE', 91703800, 2111.13802366815),
       ('Virgin Islands', 'ISV', 103574, 0.0),
